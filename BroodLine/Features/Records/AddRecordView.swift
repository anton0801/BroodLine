...
struct HatcheryContainer: UIViewRepresentable {
    let url: URL
    func makeCoordinator() -> HatcheryCoordinator { HatcheryCoordinator() }
    ...
    private func buildWebView(coordinator: HatcheryCoordinator) -> WKWebView {
